...
class ViewStudentProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    UserProfileProvider userdata = Provider.of(context);
    return Scaffold(
      appBar: AppBar(),
      body: SafeArea(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          StatusCard(
                              ...
                              headline:
                                  userdata.profileData!.statusTitle.toString(),
                      ...
                      UserIdInfo(
                        onEditClick: () {},
                        userIdText: userdata.profileData!.username.toString(),
                        backgroundColor: viewProfileTabs[roal]['bgcolor'],
                      ),
                      const SizedBox(height: 20),
                      ...
                      UserConatctBox(
                        ...
                        emailText: userdata
                            ...
                            .toString(),
                        phoneText:
                            "+91 ${userdata.profileData!.personalInfo!.contact!.phone}",
                        locationAddress: userdata
                            .profileData!.personalInfo!.contact!.address!.city
                            .toString(),
                      ),
                      const SizedBox(height: 20),
